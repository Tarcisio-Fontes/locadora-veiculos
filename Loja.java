...
public class Loja {
    	    ...
    	    try{
    	        ...
    	        switch (opcao) {
    	            ...
    	            case 5:
    	                ...
    	                break;
    	            case 6:
    	                System.out.print("\nInforme o serviço (seguro/tanque cheio/condutor adicional): ");
    ...
    public void menuComprar() {
        try {
            ...
            switch(op) {
                case 1: 
                    comprarVeiculo(carros); // Aluga carro
                    break;
                case 2:
                    comprarVeiculo(motos); // Aluga moto
                    break;
                case 3:
                    comprarVeiculo(bicicletas); // Aluga bicicleta
                    break;
                case 0: 
                    menu(); // Volta ao menu principal
                    break;
                default:
                    menuComprar(); // Repete menu se opção inválida
                    break;
            }
    ...
    public void comprarVeiculo(ArrayList<Veiculo> veiculos) {
        ...
        System.out.println("Digite o nome do veículo que será comprado: ");
        modelo = sc.nextLine();
    	...
    	if(op==1) {
    		if(!carros.isEmpty()) {
    	        ...
    	        // Tratamento para quando há vários veículos com mesmo modelo
    	            ...
    	            System.out.printf("Digite o ano do modelo desejado: ");
    	            int ano = sc.nextInt();
    	            sc.nextLine();
    ...
    public void cadastrarCarro() {
        ...
        System.out.printf("É conversível? (true/false): ");
    ...
    public void cadastrarBicicleta() {
        ...
        System.out.printf("Número de marchas: ");
        int numMarchas = sc.nextInt();
        sc.nextLine(); // Limpa buffer
        
        System.out.printf("Tipo de freio: ");
        String tipoFreio = sc.nextLine();
        
        System.out.printf("Tem suspensão? (true/false): ");
    ...
    public void cadastroInicial() {
        ...
        Carro corolla2025 = new Carro("Corolla", "Toyota", 2025, 164.590, 4, false, "Gasolina");
        corolla2025.setVeiculoTipo("carro");
        carros.add(corolla2025);

        Carro corolla2024 = new Carro("Corolla", "Toyota", 2024, 160590, 4, false, "Gasolina");
